...
//
// IMAGES : chaque produit accepte un champ `image` (URL ou chemin d'un
// visuel). Vide par défaut : le rendu retombe alors sur notre illustration
// vectorielle (ProductArt / PhoneSVG). Pourquoi ce n'est pas une photo
// Amazon : le Programme Partenaires n'autorise à publier que les visuels
// qu'il fournit lui-même (PNG générés par Link Builder, ou `Images` de la
// PA API) — télécharger un `images-fr.amazon.com/…` pour le recoller ici
// serait du scraping d'actifs. Dès que Link Builder est actif sur votre
// compte, collez ses URLs dans `image` : les cartes basculent seules.
// ============================================================
...
export const CATEGORIES = [
  {
    ...
    store: "watch",
    espace: "Apple Watch",
    visuel: "/produits/rayon-watch.jpg",
    name: "Apple Watch",
    icon: "⌚",
  ...
  },
  {
    ...
    store: "iphone",
    espace: "iPhone",
    visuel: "/produits/rayon-iphone.jpg",
    name: "Anciens iPhone",
    icon: "📱",
    blurb: "17e, 16, 15, 13 (renewed)",
    longBlurb:
      "Les générations précédentes : c'est là que se jouent les écarts les plus larges sur les iPhone (jusqu'à −23 % pour le 16 à notre relevé du 27 août 2026), même si les baisses les plus fortes du catalogue sont sur les montres et les iPad. Elles installent toutes iOS 26 ; seule la famille 17e/16 a droit à Apple Intelligence, et l'iPhone 15 comme le 13 « Renewed » en sont exclus par le matériel. Le 13 reste le choix étudiant/famille : l'iPhone le plus ancien de la sélection, celui qu'on prend quand le budget ferme la discussion.",
  },
  {
    id: "ipad",
    store: "ipad",
    espace: "iPad",
    visuel: "/produits/rayon-ipad.jpg",
    name: "iPad",
    icon: "📲",
    blurb: "A16 & Air M3",
    longBlurb:
      "L'iPad (A16) est le choix par défaut : 11 pouces, une journée d'autonomie, iPadOS 26 — mais pas Apple Intelligence, qui exige une puce M1 sur iPad. L'iPad Air (M3) l'a, et ajoute la compatibilité Apple Pencil Pro et Magic Keyboard.",
  },
  {
    id: "audio",
    store: "airpods",
    espace: "AirPods",
    visuel: "/produits/rayon-airpods.jpg",
    name: "Audio & casques",
    icon: "🎧",
    blurb: "Pro 3, 4, Max 2",
    longBlurb:
  ...
  },
  {
    id: "accessoires",
    store: "accessoires",
    espace: "Accessoires Apple",
    visuel: "/produits/rayon-accessoires.jpg",
    name: "Accessoires",
    icon: "⚡",
...
export const BOUTIQUE_PRODUCTS = [
  ...
  },
  {
    ...
    badgeTone: "amber",
    tagline:
      "Dynamic Island, USB-C, A16 Bionic et encore des années de mises à jour — une génération sous le 16, sans Apple Intelligence. C'est l'iPhone qu'on regarde quand iOS 26 suffit et que le budget ferme la discussion.",
    price: "≈ 620 – 705 €",
  ...
  // ---------- iPad ----------
  {
    ...
    badgeTone: "blue",
    tagline:
      "11″ Liquid Retina, puce A16 (celle de l'iPhone 15), autonomie d'une journée, USB-C. iPadOS 26 oui, Apple Intelligence non — la fonction demande une puce M1. La tablette « tout le monde » à prix correct.",
    price: "≈ 530 – 610 €",
  ...
  // ---------- Audio ----------
  {
    ...
    badgeTone: "blue",
    tagline:
      "La meilleure réduction de bruit du segment, capteur de fréquence cardiaque pendant les séances, traduction instantanée, 8 h d'autonomie.",
  ...
  },
  {
    ...
    badgeTone: "green",
    tagline:
      "Puce H2, réduction active du bruit, audio adaptatif et mode Transparence, 30 h avec le boîtier. L'entrée de gamme des AirPods à réduction de bruit active.",
    price: "≈ 160 – 199 €",
