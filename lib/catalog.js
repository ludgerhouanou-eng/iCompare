...
export const CATEGORIES = [
  ...
  },
  {
    ...
    longBlurb:
      "Les générations précédentes : les meilleures économies du catalogue. Tous supportent iOS 26 et Apple Intelligence, et l'iPhone 13 « Renewed » est le choix étudiant/famille qui tient la route sous les 450 €.",
  },
  {
    id: "ipad",
    name: "iPad",
...
export const BOUTIQUE_PRODUCTS = [
  ...
  },
  {
    ...
    badgeTone: "blue",
    tagline:
      "A18, 6,1″, double 48 + 12 MP, 22 h de vidéo : la précédente génération se vend désormais à ses prix les bas. Le choix « sage » sous 850 €.",
    price: "≈ 819 €",
    priceValue: "819",
  ...
  },
  {
    ...
    badgeTone: "amber",
    tagline:
      "Dynamic Island, USB-C, A16 Bionic et encore des années de mises à jour — pour 250 € de moins qu'un 16. Le meilleur rapport qualité-prix du catalogue.",
    price: "≈ 620 – 705 €",
    priceValue: "620",
  ...
  },
  {
    ...
    badgeTone: "blue",
    tagline:
      "Câble magnétique certifié Apple (MFi), compatible toutes les Apple Watch actuelles (SE, Series, Ultra). Le câbles de secours indispensable à 14 €.",
    price: "≈ 14,50 €",
    priceValue: "14",
    priceNote: "Prix constaté Amazon, 27/08/2026",
    asin: "B0DWMPW319",
...
export function productLink(asin) {
