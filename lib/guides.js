...

  {
    ...
    blocs: [
      ...
      },
      {
        ...
        p: [
          "La marque Apple n'est pas un prérequis ; la certification USB-IF et un avis de sécurité, si. Un chargeur non certifié qui fait disjoncter ou qui chauffe est un risque d'incendie, pas une économie qu'on chiffrerait ici. À puissance annoncée égale, la différence entre deux bons chargeurs se voit sur la tenue en température, pas sur la vitesse.",
        ],
      },
    ],
    faq: [
    ...
    blocs: [
      ...
      },
      {
        ...
        liste: [
          ...
          "Vous voulez surtout l'autonomie : un 16 ou 17 change le quotidien, une batterie neuve sur votre 13 change presque autant, pour une fraction du prix d'un appareil neuf.",
