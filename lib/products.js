...
export function productLink(p) {
  return p.asin ? amazonLink(p.asin) : null;
}
...
export const VERDICTS = [
  {
    ...
    text: "L'iPhone 16 affiche maintenant ses prix les plus bas depuis sa sortie. Puce A18, 48 MP, 22 h de vidéo : c'est l'iPhone « sage » si votre budget est sous 800 €. Il recevra encore plusieurs années de mises à jour.",
  },
  {
    productId: "iphone-17",
    toneClass: "v-blue",
    title: "Le choix global recommandé",
    text: "120 Hz enfin sur un modèle standard, double caméra 48 MP, 3 000 nits et 30 h d'autonomie : l'iPhone 17 comble presque tous les écarts avec la gamme Pro, pour 969 € au lancement (souvent moins sur Amazon).",
  },
  {
    productId: "iphone-18",
    toneClass: "v-purple",
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Si votre priorité est un modèle abordable : non, il faudrait attendre plus de 7 mois pour l'iPhone 18 standard. L'iPhone 17, régulièrement sous les 900 € sur Amazon, est un excellent achat en 2026. Si vous visez le haut de gamme, les iPhone 18 Pro de septembre 2026 (A20 Pro, 12 Go de RAM) valent effectivement l'attente.",
  },
  {
