...
export const PRODUCTS = [
  {
    ...
    // « Meilleur prix » affirmait une comparaison de prix que le site ne peut
    // pas faire : nous n'affichons aucun montant. Ce badge-ci dit la seule
    // comparaison que nos données soutiennent — un écart relevé, daté.
    badge: { label: "La plus forte baisse relevée", tone: "green" },
    color: "#4a72d8",
    colorDark: "#2c4796",
...
export const VERDICTS = [
  {
    ...
    text: "À notre relevé du 27 août 2026, c'est l'iPhone 16 qui affiche le plus grand écart sous son prix de lancement Apple, des trois comparés ici — le montant du jour, seul Amazon le connaît. Puce A18, 48 MP, 22 h de vidéo : c'est l'iPhone « sage » quand le budget compte. Il recevra encore plusieurs années de mises à jour.",
  },
  {
    productId: "iphone-17",
    toneClass: "v-blue",
